...
const logoimage = new THREE.DataTextureLoader().load(
  "https://i.imgur.com/lQbbCMn.png"
);
// logoimage.image = true;
// logoimage.magFilter = THREE.NearestFilter;
// logoimage.minFilter = THREE.LinearMipMapLinearFilter;
